...
public interface ProdutoRepository extends JpaRepository<Produto, Long> {
	...
	public List <Produto> findByNomeAndLaboratorio(String nome, String laboratorio);  // Buscar por Nome do Produto e pelo Nome do Laboratório. MySQL: select * from tb_produtos where nome = "produto" and laboratorio = "laboratorio";
	
	public List <Produto> findByNomeOrLaboratorio(String nome, String laboratorio);  // Buscar por Nome do Produto ou pelo Nome do Laboratório. MySQL: select * from tb_produtos where nome = "produto" or laboratorio = "laboratorio";
